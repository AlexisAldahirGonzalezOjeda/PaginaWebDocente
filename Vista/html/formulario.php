            ...
            <div id="formulario"> 
                ...
                <form name="formulario" id="formulario" method="get">
                    <div id="datos">
                        ...
                        <input type="text" name="cantidadHoras" id="cantidadHoras" list="cantidadHoras" placeholder="--Seleccione una opción--" required>
                        <br>
                        Fecha: 
                        <input type="date" name="fecha" min="2022-07-27" max="2023-12-31" required />
                        <br>
                        Franja horaria: 
                        <datalist id="franjaH">
                        ...
                        <input type="text" name="franjaH" id="franjaH" list="franjaH" placeholder="--Seleccione una opción--" required>    
                        <!--<p id="current_date"></p>
                        <script>
                            fecha = Date().split(' ');
                        ...
                        <input type="text" name="pago" id="pago" list="pago" placeholder="--Seleccione una opción--" required>
                        <br>  
