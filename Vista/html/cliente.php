...
<html>
    ...
    <body>
        ...
        if (pg_num_rows(pg_query($conn, "SELECT fecha, tipo_servicio, materia, descripcion
            ...
            $arr = pg_fetch_all(pg_query($conn, "SELECT id_servicio, fecha, tipo_servicio, nombre, apellido, materia, descripcion
                            FROM Servicio
                            INNER JOIN Materia
                            ON Materia.id_materia = Servicio.id_materia
                            INNER JOIN Profesor
                            ...
                            WHERE Servicio.id_alumno= '$id_alumno'
                            ORDER BY fecha DESC"));
            ?>  <table id="Reservas"><tr><th>Id Servicio</th><th>Fecha</th><th>Tipo servicio</th><th>Profesor</th><th>Materia</th><th>Descripcion</th></tr><?php
