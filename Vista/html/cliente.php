    ...
    <body>
        ...
        if (isset($_SESSION['error'])) {
            if ($_SESSION['error'] == true) {
                ?> 
                <div style="display: block; position: relative; left: 7%; margin-right: 10%; color: #1d244a; text-align: right; top: 300px;">
                    <p>Advertencia: En el caso que su reserva se refleje incompleta o 
                        no se haga, no se preocupe, para ese momento el docente que
