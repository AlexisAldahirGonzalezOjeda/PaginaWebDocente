                ...
                <div id="formulario"> 
                    ...
                    <form name="formulario" id="formulario" method="get">
                        <div id="datos">
                            ...
                            <input type="text" name="registro" id="registro" list="registro" placeholder=" --- Seleccione tipo de registro ---" class="boton" required> 
                            <br><br>
                            ...
                            <br>
                            <br>
                            <input type="text" name="turno" id="turno" list="turno" placeholder=" --- Seleccione su horario disponble ---" class="boton" required> 
                            <br>
                            <br>
