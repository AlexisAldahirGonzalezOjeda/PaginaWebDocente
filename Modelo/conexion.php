...
class Conexion {
    ...
    public function consultarProfesores() {
        ...
        if (!$result) {
            ...
            <input list="profesores" name="profesores" placeholder="--Seleccione una opción--" class="boton" required><?php
        }
        pg_close($conn);
    }
    ...
    public function consultarMaterias() {
        ...
        if (!$result) {
            ...
            <input list="materias" name="materias" placeholder="--Seleccione una opción--" class="boton" required><?php
        }
        pg_close($conn);
    }
