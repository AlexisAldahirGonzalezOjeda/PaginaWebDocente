...
<html>
    ...
    <body> 
        ...
        if (filter_input(INPUT_GET, "accion")) {
            ...
            if (filter_input(INPUT_GET, "accion") == "Servicios") {
                $controlador->verPagina('Vista/html/servicios.php');
            }
            ...
            if (filter_input(INPUT_GET, "accion") == "SignUp") {
                $controlador->verPagina('Vista/html/signUp.php');
            }
            if (filter_input(INPUT_GET, "accion") == "Buscar") {
                $controlador->verPagina('Vista/html/search.php');
            } 
            if (filter_input(INPUT_GET, "accion") == "FormA") {
                $controlador->verPagina('Vista/html/formA.php');
            } 
            if (filter_input(INPUT_GET, "accion") == "FormH") {
                $controlador->verPagina('Vista/html/formH.php');
            }
            if (filter_input(INPUT_GET, "accion") == "FormP") {
                $controlador->verPagina('Vista/html/formP.php');
            }
            if (filter_input(INPUT_GET, "accion") == "Form") {
                $controlador->verPagina('Vista/html/form.php');
            }
            if (filter_input(INPUT_GET, "accion") == "ElimU") {
                $controlador->verPagina('Vista/html/elimU.php');
            }
            if (filter_input(INPUT_GET, "accion") == "ModU") {
                $controlador->verPagina('Vista/html/modU.php');
            }
            if (filter_input(INPUT_GET, "accion") == "Exit") {
                $controlador->verPagina('Vista/html/salir.php');
            }
            if (filter_input(INPUT_GET, "accion") == "Cancel") {
                $controlador->verPagina('Vista/html/cancelar.php');
            }
            if (filter_input(INPUT_GET, "accion") == "FormAAdmin") {
                $controlador->verPagina('Vista/html/formAAdmin.php');
            }
            if (filter_input(INPUT_GET, "accion") == "CrearCM") {
                $controlador->verPagina('Vista/html/crearCM.php');
            }
            if (filter_input(INPUT_GET, "accion") == "ElimM") {
                $controlador->verPagina('Vista/html/elimM.php');
            }
        } else {
            $controlador->verPagina('Vista/html/principal.php');
        }
